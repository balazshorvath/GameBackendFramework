...
public class MongoDBRepo<T, ID> implements Repository<T, ID> {
    ...
    public MongoDBRepo(DB database){
        ...
        collection = JacksonDBCollection.wrap(database.getCollection(documentClass.getSimpleName()), documentClass, indexClass);
    ...
    @Override
    public List<T> findBy(String key, Object value) throws IOException {
