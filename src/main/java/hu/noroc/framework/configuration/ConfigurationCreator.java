package hu.noroc.framework.configuration;

import hu.noroc.framework.configuration.annotation.Config;
import hu.noroc.framework.configuration.annotation.ConfigValue;
